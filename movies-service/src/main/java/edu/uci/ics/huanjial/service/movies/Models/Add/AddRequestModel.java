...
public class AddRequestModel {
    ...
    public AddRequestModel(String title, String director, Integer year, String backdrop_path, Integer budget, String overview, String poster_path, Integer revenue, GenreModel[] genres) {
        this.title = title;
