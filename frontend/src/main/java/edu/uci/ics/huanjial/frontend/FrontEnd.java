package edu.uci.ics.huanjial.frontend;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.huanjial.frontend.configs.Configs;
import edu.uci.ics.huanjial.frontend.logger.ServiceLogger;
import edu.uci.ics.huanjial.frontend.models.ConfigsModel;
...
public class FrontEnd {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.huanjial.service.idm.resources");
