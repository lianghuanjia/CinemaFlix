package edu.uci.ics.huanjial.service.idm.configs;

import edu.uci.ics.huanjial.service.idm.models.ConfigsModel;
...
public class Configs {
    ...
    //Session configs
    public final long DEFAULT_TIMEOUT = 600000; // 10-minute timeout
    public final long DEFAULT_EXPIRATION = 1800000; // 30-minute expiration
    ...
    public Configs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if(timeout <= 0){
                ...
                System.err.println("Timeout is <= 0. Using default");
            }else{
            ...
            if(expiration <= 0){
                ...
                System.err.println("Expiration is <= 0. Using default");
            }else{
